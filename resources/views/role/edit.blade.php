                ...
                <div class="card-body" style="margin-left:80px">
                    <div align="left" class="mb-2">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" value="{{ $role->name }}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Role Name..." >
                            @error('name')
                                <div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <hr>
                                ...
                                @php 
                                    ...
                                    {
                                        array_push($permissions_array, $p->id);
                                    }
                                @endphp
                                    @foreach($permissions as $permission)
                                    <div class="mt-2">
                                        <label>
                                            <input type="checkbox" name="permissions[]" value="{{ $permission->id }}"  {{in_array($permission->id, $permissions_array) ? 'checked' : ''}} class="permission"> {{ $permission->name }}
                                        </label>
                                    </div>
                                    @endforeach
                                </div>
