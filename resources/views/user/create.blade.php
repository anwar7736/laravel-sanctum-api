                    ...
                    <div class="d-none">
                     <input type="search" id="search_user" class="form-control mb-2" placeholder="Search user...">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" value="" name="email" id="email" placeholder="Email..." >
                            @error('email')
                                <div>
                                    <span class="text-danger">{{$message}}</span>
                                </div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="password" value="{{ old('email') }}" class="form-control @error('password') is-invalid @enderror" value="" name="password" id="password" placeholder="Password..." >
                            @error('email')
                                <div>
                                    <span class="text-danger">{{$message}}</span>
                                </div>
